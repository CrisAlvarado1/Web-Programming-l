            ...
            <div class="col-12 col-sm8 col-md-6 m-auto">
                <div class="card border-2 shadow">
                    <div class="card-body text-center bg-light">
                        ...
                        <hr class="my-2">
                        <form method="post" action="/Workshop 7/registerUser.php" class="form-inline" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="profile" class="form-control my-2 py-2" type="file" name="profilePicture" accept="image/*" required>
                            </div>
                            ...
                            <div class="text-center my-1 py-1">
                                <a href="/Workshop%207/index.php" class="link-primary">Already have an account?</a>
                            </div>
                        </form>
                    </div>
                </div>
