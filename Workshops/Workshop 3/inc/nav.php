  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="container-fluid justify-content-end">
      <div class="navbar-nav">
        ...
        <a class="nav-link fs-5 <?php echo ($activePage == 'dashboard') ? 'active' : ''; ?>" href="/Workshop%203/dashboard.php">Home</a>
        <a class="nav-link fs-5" <?php echo ($activePage == 'trees') ? 'active' : ''; ?> href="#">Arboles</a>
        <?php if ($user['role'] === 'admin') { ?>
          <a class="nav-link <?php echo ($activePage == 'users') ? 'active' : ''; ?>" href="/Workshop%203/users/users.php">Users</a>
        <?php } ?>
