  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="container-fluid justify-content-end">
      <div class="navbar-nav">
        <a class="nav-link fs-5 <?php echo ($activePage == 'dashboard') ? 'active' : ''; ?>" 
        href="http://isw613.com/Workshop%203/dashboard.php">Home</a>
        ...
        <?php  if($user['role'] === 'admin') { ?>
          ...
          href="http://isw613.com/Workshop%203/users/users.php">Users</a>
        <?php } ?>
